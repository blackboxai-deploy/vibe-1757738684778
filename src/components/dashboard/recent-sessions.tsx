...
import { formatarDuracao, formatarDataHora } from '@/lib/calculations';
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400">
                    {(() => {
                      ...
                      return `${formatarDuracao(horasHoje)} em ${sessoesHoje.length} sessão${sessoesHoje.length > 1 ? 'ões' : ''} • ${metasHoje} meta${metasHoje > 1 ? 's' : ''}`;
                    })()}
                  </p>
                </div>
              </div>
